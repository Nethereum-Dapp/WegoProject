...
public class RubiTokenWrapper
{
    ...
    public TransactionInput CreateBalanceOfCallInput(string address)
    {
        var function = GetFunctionbalanceOf();
        return function.CreateTransactionInput(address);
    }
}
